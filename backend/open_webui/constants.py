...
class ERROR_MESSAGES(str, Enum):
    ...
    INVALID_EMAIL_DOMAIN = "The email domain you entered is invalid. Please double-check and make sure you're using a valid email domain that is whitelisted (e.g., yourname@aelf.io)."
    INVALID_EMAIL_FORMAT = "The email format you entered is invalid. Please double-check and make sure you're using a valid email address (e.g., yourname@aelf.io)."
    INVALID_PASSWORD = (
